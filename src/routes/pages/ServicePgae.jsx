...
export default function ServicePage(){
    return(
     <div>
           ...
           <AboutSection aboutUsImg={servicesImg} showHeading={true} mainHeading='Business Energy'/>
           <AboutSection2 aboutUsImg={servicesImg2}/>
           <AboutSection aboutUsImg={servicesImg3}/>
           <AboutSection aboutUsImg={servicesImg} showHeading={true} mainHeading='Business Gas'/>
           <AboutSection2 aboutUsImg={servicesImg2}/>
           <AboutSection aboutUsImg={servicesImg3}/>
     </div>
    )
